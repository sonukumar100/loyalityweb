            ...
            {selected.map(option => {
              return (
                <Badge
                  key={option.value}
                  className={cn(
                    'data-[disabled]:bg-muted-foreground bg-[lightgrey] font-medium text-inherit data-[disabled]:text-muted data-[disabled]:hover:bg-muted-foreground cursor-pointer',
