...
export default function CouponForm() {
  ...
  const { useAddCouponMutation } = useCouponSlice();
  ...
  const [addCoupon, { isError, isLoading }] = useAddCouponMutation();
            ...
            <div>
              ...
              {errors.CouponImage && (
                <p className="text-[14px] text-red-500 mt-1">
                  {(errors.CouponImage as any).message}
                </p>
              )}
            </div>
