...
export function AddBuilderFormProfile() {
  ...
  const { useCampaiganListQuery, useGetStatesQuery } = useBuilderSlice();
      ...
      <div className="rounded-24 bg-white py-10 px-10">
        ...
        <div className="flex justify-between items-center full px-2 mt-12">
          <div className="relative max-w-[14rem]">
            <div className="pr-2 before:content-[''] before:absolute before:top-[.6rem] before:w-[.1rem] before:-right-[4.5rem] before:h-[3rem] before:bg-[#EAECF0]">
              <h6 className="font-poppins text-base text-secondary">
                Builder Company
              </h6>
              <h2 className="text-primary text-base font-poppins font-medium mt-4">
                {form.watch('builderCompany') || '_'}
              </h2>
            </div>
          </div>
          ...
          <div className="relative max-w-[15rem]">
            <div className="pr-2 before:content-[''] before:absolute before:top-[.6rem]">
              <h6 className="font-poppins text-base text-secondary">
                Annual Volume
              </h6>
              <h2 className="text-primary text-base font-poppins font-medium mt-4">
                {form.watch('annualVolume')
                  ? formatAmount(form.watch('annualVolume'))
                  : '_'}
              </h2>
            </div>
          </div>
