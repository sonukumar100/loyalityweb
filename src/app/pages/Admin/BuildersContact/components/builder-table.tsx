...
import BuilderFilter from './builder-filter';
...
const BuildersTable = (props: BuildersTableProps) => {
  const { search, setSearch, table, pagination, columns, builderListData } =
    props;
            ...
            <div className="flex items-center pl-6 justify-start space-x-2 py-4">
              <div className="flex items-center  pl-6 space-x-10 py-4">
                ...
                <p className="text-gray-500 font-normal text-base font-poppins">
                  ...
                  {builderListData?.data?.totalDocuments} rows selected
                </p>
              </div>
            </div>
          </div>
