...
export function AddAgentsFormProfile() {
  ...
  //////// CAMPAGIAN LIST ////////////
  const { useCampaiganListQuery, useGetStatesQuery } = useAgentSlice();
  ...
  const loadOfficer = loadOfficerData?.data?.documents;
  // console.log('loadOfficer', loadOfficer);
  ...
  return (
    <>
      <div className="rounded-24 bg-white py-10 px-10">
            ...
            <div className="ml-4">
              ...
              <p className="flex mt-2">
                ...
                <span className="text-[#12B76A] text-12 font-poppins font-normal ml-2">
                  {settingConfig.currentCompany.find(
                    f => f.key == form.watch(''),
                  )?.value || '_'}
                </span>
              </p>
        ...
        <div className="flex justify-between items-center full px-2 mt-12 mb-5">
          ...
          <div className="relative max-w-[10rem]">
            <div className="pr-2 before:content-[''] before:absolute before:top-[.6rem] before:w-[.1rem] before:-right-[.5rem] before:h-[3rem] before:bg-[#EAECF0]">
              ...
              <h2 className="text-primary text-base font-poppins font-medium mt-4">
                {loadOfficer?.filter(
                  d => d._id === form.watch('assignedLoanOfficer'),
                )?.[0]?.fullName || '_'}
              </h2>
            </div>
          </div>
          ...
          <div className="relative max-w-[9rem]">
            ...
            <h2 className="text-primary text-base font-poppins font-medium mt-4">
              {campaignListData?.find(f => f._id == form.watch('opportunity'))
                ?.title || '_'}
            </h2>
          </div>
        </div>
